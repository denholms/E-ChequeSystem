...
public class EChequeIOTest {
    ...
    // TC 1.1.6.1
    @Test
    public void TC1161TestSaveChequeSerializesEChequeToFile() throws IOException{
    ...
    public void TC1162TestSaveChequeThrowsIOExceptionForInvalidFilePath() throws IOException{
        // Arrange
        ECheque eCheque = new ECheque();
        eCheque.setaccountholder("Jon Doe");
        eCheque.setaccountNumber("27");
    ...
    // TC 1.1.6.3
    @Test(expected = IOException.class)
    public void TC1163TestSaveChequeThrowsIOExceptionWhenFileAlreadyExists() throws IOException{
        // Arrange
        ECheque eCheque = new ECheque();
        eCheque.setaccountholder("Jon Doe");
        eCheque.setaccountNumber("27");
    ...
    public void TC1164TestSaveChequeThrowsIllegalArgumentExceptionForNullECheque() throws IOException{
    ...
    // TC 1.1.6.5
    @Test
    public void TC1165TestReadChequeReturnsCorrentEChequeForValidFilePath() throws ClassNotFoundException, IOException{
        // Arrange
        ECheque eCheque = new ECheque();
        eCheque.setaccountholder("Jon Doe");
        eCheque.setaccountNumber("27");
    ...
    // TC 1.1.6.6
    @Test(expected = IOException.class)
    public void TC1166TestReadChequeThrowsIOExceptionForInvalidFilePath() throws ClassNotFoundException, IOException{
        EChequeIO eChequeIO = new EChequeIO();
    ...
    public void TC1167TestReadChequeThrowsIOExcepptionWhenFilePathIsDirectory() throws ClassNotFoundException, IOException{
        EChequeIO eChequeIO = new EChequeIO();
    ...
    // TC 1.1.6.8
    @Test
    public void TC1168TestReadChequeReturnsNullForNonEChequeFileType() throws ClassNotFoundException, IOException{
        // Arrange
        EChequeIO eChequeIO = new EChequeIO();
